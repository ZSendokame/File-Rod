...
if($Action -eq ".flash") {
    ...
    Write-Output ".help Shows this message", ".backup Backup your files", ".flash Delete files", ".getPath Shows the actual path", ".clear Clean Terminal", ".rename Rename a File"
